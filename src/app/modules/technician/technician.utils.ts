export const technicianInvitationTemplate = (shopName: string, passkey: string) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; border-radius: 10px;">
      ...
      <p style="font-size: 16px; color: #555;"> You have been invited by <strong>${shopName}</strong> to join their team as a technician on the SmartAutoTech.ai platform.</p>
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://smartautotech.ai/login" style="background-color: #007bff; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Login to Dashboard</a>
      </div>
      ...
      <p style="font-size: 12px; color: #aaa; text-align: center;">&copy; 2026 SmartAutoTech.ai - Powered by Advanced Automotive AI</p>
    </div>
  `;
};
